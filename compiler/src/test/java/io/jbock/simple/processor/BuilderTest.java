    ...
    void builderParameter() {
        ...
        assertThat(compilation).generatedSourceFile("test.TestClass_AComponent_Impl")
                .containsLines(
                        ...
                        "    @Override",
                        "    public TestClass.AComponent build() {",
                        "      TestClass.A a = this.mockBuilder != null && this.mockBuilder.a != null ? this.mockBuilder.a : new TestClass.A(this.s);",
                        "      TestClass.B b = this.mockBuilder != null && this.mockBuilder.b != null ? this.mockBuilder.b : new TestClass.B(a);",
                        "      return new TestClass_AComponent_Impl(b);",
                        "    }",
                        "",
                        "    public MockBuilder2 withMocks() {",
                        "      return new MockBuilder2(this.s);",
                        "    }",
                        "",
                        "    @Override",
                        "    public Builder_Impl withS(String s) {",
